...
\begin{document}
	...
	\input{2-textuais/2-objetivos-especificos}
	\input{2-textuais/3-revisao-teorica}
	\input{2-textuais/4-metodologia}
	\input{2-textuais/5-arquitetura}
	\input{2-textuais/5b-validacao-tecnica}
	\input{2-textuais/6-resultados-esperados}
	\input{2-textuais/7-cronograma}
	\input{2-textuais/8-consideracoes-finais}
