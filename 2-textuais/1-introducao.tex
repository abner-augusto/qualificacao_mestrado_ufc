...
A \gls{NR}-01 \cite{brasil2024nr01}, em seu tópico 1.7, destaca a capacitação contínua em \gls{SST}, exigindo atualizações periódicas para preparar os trabalhadores para os riscos ocupacionais, uma abordagem reforçada pela NR-18 \cite{brasil2025nr18}, que foca na prevenção de acidentes e na criação de ambientes seguros na construção civil, e pela NR-35 \cite{brasil2023nr35}, específica para o trabalho em altura — risco central no perfil de acidentes aqui descrito. Para atender a essas exigências, o treinamento em \gls{RV} surge como alternativa tecnológica que permite aos trabalhadores praticar, de forma imersiva e segura, a identificação de riscos, o uso correto de \glspl{EPI} e \glspl{EPC} e a resposta a emergências, sem exposição a perigos reais. Essa tecnologia não só melhora a retenção do conhecimento, mas também fortalece a cultura de segurança, contribuindo para a redução de acidentes e o cumprimento das normas regulamentadoras.
