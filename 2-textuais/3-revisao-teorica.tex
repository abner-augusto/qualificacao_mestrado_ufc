...
\subsubsection{Questionário de Motivação e Engajamento}

Além das medidas cognitivas, a motivação e o engajamento dos participantes serão avaliados por questionário aplicado após o treinamento a ambos os grupos, permitindo comparação direta entre o método imersivo e o vídeo instrucional. Essa dimensão é relevante porque, conforme \citeonline{joshi2021}, o maior engajamento no treinamento em RV tende a se converter em melhor retenção de conhecimento a longo prazo, mesmo quando o ganho imediato é similar ao de métodos tradicionais.
