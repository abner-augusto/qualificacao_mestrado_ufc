...
O desenvolvimento da Fase 1 do protótipo do sistema de treinamento em Realidade Virtual (RV) será orientado e validado por consultas a especialistas em segurança do trabalho, incluindo engenheiros de segurança e instrutores de NR-18 \cite{brasil2025nr18} e NR-35 \cite{brasil2023nr35}, bem como representantes de empresas e entidades do setor da construção civil, como o \gls{SENAI} e o SINDUSCON-CE.

Essas consultas definem os elementos a priorizar nos cenários virtuais, considerando as principais causas de acidentes no setor, as dificuldades dos instrutores na transmissão de conhecimentos e os temas de maior relevância para o público-alvo. O foco desta fase são as quedas de altura e o uso correto de Equipamentos de Proteção Individual (EPIs), situações de maior impacto e maior potencial de aproveitamento das características imersivas da RV.
...
Os instrumentos foram selecionados para cobrir as três hipóteses do estudo com o mínimo de sobrecarga para os participantes, mantendo a viabilidade em pesquisa piloto.
...
Após o treinamento, entrevistas semiestruturadas com o grupo experimental comporão uma análise qualitativa. Elas visam explorar a experiência subjetiva, coletar percepções sobre o realismo e a utilidade do treinamento, identificar pontos fortes e fracos e obter sugestões de melhoria para fases futuras.
